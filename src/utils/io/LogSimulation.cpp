...
#include "src/utils/observables/WallCoverageFraction.h"
...
void LogSimulation::dumpState(Box& box, std::vector<Cell>& cells, double rv, int simstep, int numV, int nbhandler)
{
    ...
    fprintf(os, "%i %i %8.6f %8.6f %8.6f %10.6f %10.6f\n", simstep, numofcells, boxVolume, pressure, volume_frac, area_coverage, mean_stress);
