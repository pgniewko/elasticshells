...
{
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, v1->r_c.x, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, v1->r_c.y, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, v1->r_c.z, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, v1->f_c.x, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, v1->f_c.y, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, v1->f_c.z, DELTA14);
    CPPUNIT_ASSERT_EQUAL(-1, v1->getId());
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, v1->getMass(), DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, v2->r_c.x, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, v2->r_c.y, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, v2->r_c.z, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, v2->v_c.x, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, v2->v_c.y, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, v2->v_c.z, DELTA14);
    ...
    tmpv1.setId(1);
    tmpv1.setMass(12.0);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, tmpv1.r_c.x, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0, tmpv1.r_c.y, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(3.0, tmpv1.r_c.z, DELTA14);
...
void VertexTests::testCopyConstructor()
{
    Vertex tmpv1(*v3);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(-1.0, tmpv1.r_c.x, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, tmpv1.r_c.y, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0, tmpv1.r_c.z, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, tmpv1.v_c.x, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, tmpv1.v_c.y, DELTA14);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, tmpv1.v_c.z, DELTA14);
