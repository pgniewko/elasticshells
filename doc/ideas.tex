...
\begin{enumerate}
 ...
 \begin{enumerate}
  ...
  The advantage oevr Langevin dynamics is that DD does not assume  the background dissipation to be the dominant mode of dissipation - e.g. dissipative forces may be transfered to neighboriing cells.
