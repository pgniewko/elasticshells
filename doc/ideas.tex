...
\subsection{Dissipative Particle Dynamics \cite{ums:02}}
\begin{itemize}
 ...
 $\omega^{2}_{r} = \omega_{D}(r)$ and $\sigma^2 = 2k_BT\gamma$.
 \item BD does not conserve momenta. In fact, the only thing BD conserves is number of particles. 
